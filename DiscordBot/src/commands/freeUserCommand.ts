...
export default class FreeUserCommand extends BaseCommand {
    ...
    public async process(commandData: CommandData): Promise<void> {
        ...
        // Get tagged user
        let freed = commandData.message.guild.member(commandData.message.mentions.users.first());
        ...
        let commandUserEmbed = this.createCommandUserEmbed(freed, commandData.message);
