...
export default class ServerInfoCommand extends BaseCommand {
  ...
  public getHelp(): IBotCommandHelp {
    return {
      caption: "?serverinfo",
      description: "Here is some information about our server"
    };
  }
  ...
  public async process(commandData: CommandData): Promise<void> {
    ...
    embed.addField(
      ...
      commandData.message.guild.name,
      false
    );
    embed.addField(
      "Was created on:",
      commandData.message.guild.createdAt.toString(),
      false
    );
    embed.addField(
      "You joined us on:",
      commandData.message.member.joinedAt.toString(),
      false
    );
    embed.addField(
      "Our member count is currently at:",
      commandData.webBotService.GetServerPopulation().toString(),
      false
    );
  }
}
